...
public class ReporteController {
    ...
    @GetMapping("/reportePorCategoria")
    public ResponseEntity<Resource> reporteCategoria(@RequestParam String tipo)
            throws IOException {
        return reporteService.generaReporte("reportePorCategoria", null, tipo);
    }
    
    @GetMapping("/reportePorPrecio")
    public ResponseEntity<Resource> reportePorPrecio(
        ...
        @SuppressWarnings("unchecked")
        Map<String, Object> parametros = new HashMap();
        parametros.put("precioInf", precioInf);
        parametros.put("precioSup", precioSup);
        return reporteService.generaReporte("reportePorPrecio", parametros, tipo);
    }
}
